...
-   Tabela da Diretoria de Alternativas Penais - Dicap -  com as informações das cidades que possuem Centros
...
-   Indicador 12: Existência de Centro de Alternativas Penais - Ciap.
...
4.  Somado um ponto ao município que contém Ciap.

Dessa forma, a nota geral é dada pela seguinte equação:

$$
Nota \ geral = \dfrac{\sum_{i=1}^{12} (Indicador \ i \ \times Peso \ i) }{\sum_{i=1}^{12}Peso \ i}
$$
...
A tabela abaixo traz o resumo dos principais indicadores de cada grupo. Dessa forma, fica evidente a superioridade das médias gerais para os grupos 3 e 4, respectivamente. Porém, em relação à quantidade de presos sem condenação e suas respectivas taxas, o grupo 2 supera o quarto cluster nos dois quesitos.
...
## Tabela com relação a População Prisional e a Taxa de Presos sem Condenação

A tabela abaixo lista os municípios e suas respectivas prioridades.
...
possui três municípios listados (Salvador, Barreiras e Feira de Santana).
...
mais propícios para implantação do projeto de Clínicas de Acesso a Direitos.

As listas com as prioridades considera, entre outros aspectos, a população prisional e, nesse aspecto, cerca de 242.000
pessoas (23,38%) poderão ser beneficiadas. Além disso, as pessoas custodiadas sem condenação, presentes nos municípios prioritários, somam 47.755 pessoas e representam 23,5% do total de custodiados nessa situação em todo o Brasil. 

Por fim, as cidades priotárias citadas neste trabalho abrangem cerca de 17,3% da população brasileira, 23,38% da
população prisional e 23,5% da população prisional custodiada sem condenação.
